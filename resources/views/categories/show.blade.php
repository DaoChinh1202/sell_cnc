...
@section('title', $categoryName . ' — Lumière Jewelry')
...
<header class="site-header">
    <div class="container site-header__main"><button class="menu-toggle" aria-label="Mở menu">☰</button><a href="{{ route('home') }}" class="brand"><img src="{{ asset('assets/images/duy-hoang-cnc-logo-vector.svg') }}" alt="Duy Hoàng CNC"></a><form class="search"><input type="search" placeholder="Tìm kiếm mẫu CNC..." aria-label="Tìm kiếm"><button aria-label="Tìm kiếm">⌕</button></form></div>
